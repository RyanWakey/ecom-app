...
class ProductSeeder extends Seeder
{
    ...
    {   
        $products = [
            [
                'name' => "Laptop Pro",
                'description' => "The Laptop Pro offers a seamless blend of power and elegance, 
            ...
            [
                'name' => "Iphone X ",
                'description' => "The iPhone X stands as a landmark in smartphone design, 
            ...
            [
                ...
                'description' => "Step into a personal audio oasis with our state-of-the-art Bluetooth headphones, 
                ...
                Pair them effortlessly with your device and step into a world where superior sound meets unmatched convenience.",
                'price' => 250.50,
                'stock' => 40,
            ...
            [
                'name' => "Running Shoes",
                'description' => "Elevate your running game with our premium running shoes, 
            ...
            [
                'name' => "Yoga Mat",
                'description' => "Discover the perfect foundation for your yoga practice with our high-performance 
            ...
            [
                'name' => "Tennis Racket",
                'description' => "Elevate your game with the latest innovation in tennis technology. 
            ...
            [
                ...
                'description' => "Embark on a magical journey with the Harry Potter Collection, 
